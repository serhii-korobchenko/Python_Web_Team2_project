...
#  new                      - "changeadress' name new_adress" - change  adress
...
help_information = ' Bot undestands next commands:\
          ...
          * "changeemail" name new_email" - change all emails on new one\
          * "addadress" name text" - add adress to record\
          * "changeadress" name new_adress " - change  adress\
          * "addbirthday" name" - add birthday to record \
          * "delbirthday" name" - delete birthday from record\
          * "findbytag" tag" - looking for note by tag\
          * "daysbeforebirth" # days" - check birthdays in time period \
...
@show_error
def changeadress_func (name, new_adress):
    change_adress_DB(name, new_adress)
    print('Adress has been changed successfully!')
    flash('Adress has been changed successfully!')
...
def main(command):
    ...
    commands_dict = {'hello': hello_func, 'add': add_func, 'change': change_func,
                     ...
                     'findbytag': findbytag_func, 'changeadress': changeadress_func,
